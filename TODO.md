...
- [x] **Finalize the second 2026-08-16 OTA-bootstrap batch as trunk lights --
  ...
  (Ben/Codex).
- [ ] **Finalize the forty-board canopy/extra-candidate allocation.** Batch 1:
  ...
  `F2BE94`. All are OTA-ready with blank roles, AUTO class override, and a
  provisional 6 Ah profile. If assigned to
