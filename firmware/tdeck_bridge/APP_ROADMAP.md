...
| Wake / Schedule | Performance Hold USB-flashed on `8EB508` | Wake Fleet retains its approximately 16-minute maximum session. Confirmed Performance Hold repeats the same inspection-safe command for one hour, with a bounded ten-minute fixture tail; Auto/Night cancels. Validate one full timer-wake catch plus control expiry/fallback. |
